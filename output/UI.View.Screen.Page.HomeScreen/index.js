...
var UI_View_Component_DrListElement = require("../UI.View.Component.DrListElement");
var UI_View_Component_ToolBar = require("../UI.View.Component.ToolBar");
var view = function (push) {
    return function (state) {
        return PrestoDOM_Elements_Elements.linearLayout(Data_Semigroup.append(Data_Semigroup.semigroupArray)([ PrestoDOM_Properties.height(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.width(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties.orientation("vertical"), PrestoDOM_Properties.gravity("center_horizontal"), PrestoDOM_Properties.padding("0,0,0,513"), PrestoDOM_Properties.background(UI_Constant_Color_Default.a_FFFFFFFF), PrestoDOM_Properties.cornerRadius("0"), PrestoDOM_Properties.root(true), PrestoDOM_Properties.clickable("true") ])(UI_Controller_Screen_Page_HomeScreen.overrides("Group")(push)(state)))([ PrestoDOM_Core.mapDom(UI_View_Component_ToolBar.view)(push)(state.toolBar1State)(UI_Controller_Screen_Page_HomeScreen.ToolBar1Action.create)([ PrestoDOM_Properties_SetChildProps.height_c(new PrestoDOM_Types_DomAttributes.V(56)), PrestoDOM_Properties_SetChildProps.width_c(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties_SetChildProps.override_c("t_subjects")("List of Doctors") ]), PrestoDOM_Core.mapDom(UI_View_Component_DrListElement.view)(push)(state.drListElement1State)(UI_Controller_Screen_Page_HomeScreen.DrListElement1Action.create)([ PrestoDOM_Properties_SetChildProps.height_c(new PrestoDOM_Types_DomAttributes.V(50)), PrestoDOM_Properties_SetChildProps.width_c(PrestoDOM_Types_DomAttributes.Match_Parent.value), PrestoDOM_Properties_SetChildProps.margin_c("10,20,10,0"), PrestoDOM_Properties_SetChildProps.override_c("t_hospitalName")("Koramangala") ]) ]);
    };
};
