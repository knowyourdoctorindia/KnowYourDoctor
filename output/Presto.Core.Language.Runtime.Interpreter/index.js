...
var readState = Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Control_Monad_State_Class.get(Control_Monad_State_Trans.monadStateStateT(Control_Monad_Aff.monadAff)))(function ($95) {
    return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Monad_Aff_AVar.peekVar($95));
});
...
var interpret = function (v) {
    return function (v1) {
        if (v1 instanceof Presto_Core_Types_Language_Flow.CallAPI) {
            return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Presto_Core_Language_Runtime_API.runAPIInteraction(v.value2)(v1.value0))(function ($96) {
                return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v1.value1($96));
            }));
        };
        if (v1 instanceof Presto_Core_Types_Language_Flow.RunUI) {
            return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(runUIInteraction(v.value0)(v1.value0))(function ($97) {
                return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v1.value1($97));
            }));
        };
        ...
        if (v1 instanceof Presto_Core_Types_Language_Flow.Get && v1.value0 instanceof Presto_Core_Types_Language_Flow.LocalStore) {
            return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(Presto_Core_LocalStorage.getValueFromLocalStore(v1.value1))(function ($98) {
                return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v1.value2($98));
            }));
        };
        if (v1 instanceof Presto_Core_Types_Language_Flow.Get && v1.value0 instanceof Presto_Core_Types_Language_Flow.InMemoryStore) {
            return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(readState)(function ($99) {
                return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Aff.monadAff))(v1.value2(Data_StrMap.lookup(v1.value1)($99)));
            });
        };
        ...
        if (v1 instanceof Presto_Core_Types_Language_Flow.Fork) {
            return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(forkFlow(v)(v1.value0))(function ($100) {
                return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Aff.monadAff))(v1.value1($100));
            });
        };
        if (v1 instanceof Presto_Core_Types_Language_Flow.DoAff) {
            return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(v1.value0))(function ($101) {
                return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Aff.monadAff))(v1.value1($101));
            });
        };
        if (v1 instanceof Presto_Core_Types_Language_Flow.RunScreen) {
            return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(v1.value0))(function ($102) {
                return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Aff.monadAff))(v1.value1($102));
            });
        };
        if (v1 instanceof Presto_Core_Types_Language_Flow.ForkScreen) {
            return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Data_Functor["void"](Control_Monad_State_Trans.functorStateT(Control_Monad_Aff.functorAff))(Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Monad_Aff.forkAff(v1.value0))))(function () {
                return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Aff.monadAff))(v1.value1);
            });
        };
        if (v1 instanceof Presto_Core_Types_Language_Flow.Await) {
            return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Monad_Aff_AVar.peekVar(v1.value0)))(function ($103) {
                return Control_Applicative.pure(Control_Monad_State_Trans.applicativeStateT(Control_Monad_Aff.monadAff))(v1.value1($103));
            });
        };
        ...
        if (v1 instanceof Presto_Core_Types_Language_Flow.HandleError) {
            return Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(Control_Bind.bind(Control_Monad_State_Trans.bindStateT(Control_Monad_Aff.monadAff))(run(v)(v1.value0))(runErrorHandler))(function ($104) {
        ...
        if (v1 instanceof Presto_Core_Types_Language_Flow.CheckPermissions) {
            return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(v.value1.value0(v1.value0))(function ($105) {
                return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v1.value1($105));
            }));
        };
        if (v1 instanceof Presto_Core_Types_Language_Flow.TakePermissions) {
            return Control_Monad_Trans_Class.lift(Control_Monad_State_Trans.monadTransStateT)(Control_Monad_Aff.monadAff)(Control_Bind.bind(Control_Monad_Aff.bindAff)(v.value1.value1(v1.value0))(function ($106) {
                return Control_Applicative.pure(Control_Monad_Aff.applicativeAff)(v1.value1($106));
            }));
        };
