...
var $$eval = function (v) {
    return function (state) {
        if (v instanceof DrListElementAction) {
            return state;
        };
        ...
        throw new Error("Failed pattern match at UI.Controller.Component.DrListElement line 34, column 1 - line 37, column 17: " + [ v.constructor.name, state.constructor.name ]);
    };
};
module.exports = {
