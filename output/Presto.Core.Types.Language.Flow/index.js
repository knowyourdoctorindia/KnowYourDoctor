...
var ForkScreen = (function () {
    function ForkScreen(value0, value1) {
        this.value0 = value0;
        this.value1 = value1;
    };
    ForkScreen.create = function (value0) {
        return function (value1) {
            return new ForkScreen(value0, value1);
        };
    };
    return ForkScreen;
})();
...
var runScreen = function (screen) {
    return wrap(new RunScreen(Control_Monad_Aff.makeAff(function (err) {
        return function (sc) {
...
var forkScreen = function (screen) {
    return wrap(new ForkScreen(Control_Monad_Aff.makeAff(function (err) {
        return function (sc) {
            return PrestoDOM_Core.runScreen(screen)(sc);
        };
    }), Data_Unit.unit));
